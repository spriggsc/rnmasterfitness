<?php
	...
	$brick_shop_rp             = ($GLOBALS['brick_option']['shop-rp'] && $GLOBALS['brick_option']['shop-rp'] == 1) ? "true" : "false";
	$brick_shop_rpn            = ($GLOBALS['brick_option']['shop-rpn']) ? $GLOBALS['brick_option']['shop-rpn'] : 3;
 ?>
<?php if ($brick_shop_rp == "true"): ?>
	<?php
		$posts_number = ($GLOBALS['brick_option']['shop-rpn']) ? $GLOBALS['brick_option']['shop-rpn'] : 8;
	...
	<?php if ($terms): ?>
		...
		<?php if ($related_products->have_posts()): ?>
			<div class="nz-related-products column-<?php echo esc_html($posts_number); ?>">
				<div class="related-products-title"><h3><?php echo esc_html__('Related products', 'brick'); ?></h3></div>	
