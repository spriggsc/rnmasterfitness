...
$id='header-style-4';
 if (!is_front_page() ): ?>
	<?php $class='class=headerwithbg'; ?>
	<?php $id='header-style-4-inner'; ?>
<?php endif ?>
	<!-- header --><header >
		<!-- header-style-4 -->
		<div id="header-style-4" <?php echo esc_attr( $class ); ?>>
			<!-- top-content -->
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="table-content">
								...
								<div class="table-cell cart-n-search">
								<?php if (isset($GLOBALS['woocommerce'])): ?>
									<!-- mini-cart -->
								    <div id="dropdown-cart-wrapper" class="cart-wrapper">
								    	<a href="#" class="cart-handler">
								    		<img class="cart" src="<?php echo get_template_directory_uri(); ?>/images/cart-icon.png" alt="">
