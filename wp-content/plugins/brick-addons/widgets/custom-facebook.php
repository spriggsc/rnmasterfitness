<?php 
	...
	add_action('widgets_init', 'Brick_register_facebook_like_widget');
	function Brick_register_facebook_like_widget(){
		register_widget( 'Brick_WP_Widget_Facebook_Like_Box' );
	} 

	class Brick_WP_Widget_Facebook_Like_Box extends WP_Widget {

		public function __construct() {
			parent::__construct(
				'facebook',
				esc_html__('* Facebook Like Box', 'brick'),
				array( 'description' => esc_html__('Facebook Like Box widget', 'brick'))
			);
		}
		...
		public function widget( $args, $instance ) {
	 	...
	 	public function form( $instance ) {
	 		...
	 		$defaults = array(
	 			'title'       => esc_html__('Find us on Facebook', 'brick'),
	 			'href'        => '',
	 			'app_id'      => '',
	 			'show_faces'  => 'on',
	 			'show_border' => 'on',
			...
			<p>
				<label for="<?php echo $this->get_field_id('href'); ?>"><?php echo esc_html__( 'Facebook Page URL:', 'brick' ); ?></label>
			...
			<p>
				<label for="<?php echo $this->get_field_id('app_id'); ?>"><?php echo esc_html__( 'App ID from the app dashboard:', 'brick' ); ?></label>
			...
			<p>
				...
				<label for="<?php echo $this->get_field_id('show_faces'); ?>"><?php echo esc_html__( 'Show faces', 'brick' ); ?></label>
			</p>
			<p>
				...
				<label for="<?php echo $this->get_field_id('show_border'); ?>"><?php echo esc_html__( 'Show border', 'brick' ); ?></label>
			</p>
			<p>
				...
				<label for="<?php echo $this->get_field_id('stream'); ?>"><?php echo esc_html__( 'Show stream', 'brick' ); ?></label>
			</p>
			<p>
				...
				<label for="<?php echo $this->get_field_id('header'); ?>"><?php echo esc_html__( 'Show facebook header', 'brick' ); ?></label>
			</p>
			<?php
		}
